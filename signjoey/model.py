...
class SignModel(nn.Module):
    ...
    def __init__(
        ...
        self.txt_bos_index = self.txt_vocab.stoi[BOS_TOKEN(cfg_data, tokenizer)]
        self.txt_pad_index = self.txt_vocab.stoi[PAD_TOKEN(cfg_data, tokenizer)]
        self.txt_eos_index = self.txt_vocab.stoi[EOS_TOKEN(cfg_data, tokenizer)]
...
def build_model(
    ...
    txt_padding_idx = txt_vocab.stoi[PAD_TOKEN(cfg_data, tokenizer)]
